...
namespace sealtest
{
    TEST(FPGATests, ProcessVectorDummyTest)
    {
        ...
        {
            // std::cout << "Input[" << i << "]: (" << input_vector[i].real() << ", " << input_vector[i].imag() << "i)" << std::endl;
            // std::cout << "Expected[" << i << "]: (" << expected_vector[i].real() << ", " << expected_vector[i].imag() << "i)" << std::endl;
            // std::cout << "Result[" << i << "]: (" << result_vector[i].real() << ", " << result_vector[i].imag() << "i)" << std::endl;
